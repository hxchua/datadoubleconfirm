...
**Notebook**: PT_Ridership_Monthly.ipynb     
**Description**: Python code generated by Google API Mode (Gemini) based on prompt "python code to read in a pdf hosted online and extract tables from the code". Used to scrape data from PDF published by Land Transport Authority on Average Public Transport Ridership By Month (2019 to 2025) in Singapore: Average Daily Ridership (‘000).           
